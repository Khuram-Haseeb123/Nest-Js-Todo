import { Controller, Res, HttpStatus, Post, Get, Param, Body, Patch, Query, Delete, NotFoundException } from "@nestjs/common";
...
export class NoteController {
    ...
    async deleteCustomer(@Res() res, @Param('noteId') _id:string) {
